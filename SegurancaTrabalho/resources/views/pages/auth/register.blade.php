        ...
        <div class="col-md-8 ps-md-0">
          <div class="auth-form-wrapper px-4 py-5">
            ...
            <form class="forms-sample">
              <div class="mb-3">
                <label for="exampleInputUsername1" class="form-label">Nome de Usuário</label>
                <input type="text" class="form-control" id="exampleInputUsername1" autocomplete="Username" placeholder="Nome de Usuário">
              </div>
              <div class="mb-3">
                <label for="userEmail" class="form-label">Endereço de E-mail</label>
                <input type="email" class="form-control" id="userEmail" placeholder="Endereço de E-mail">
              </div>
              <div class="mb-3">
              ...
              <div>
                <a href="{{ url('/') }}" class="btn btn-primary me-2 mb-2 mb-md-0">Cadastrar</a>
              ...
              <p class="mt-3 text-secondary">Já tem uma conta?<a href="{{ url('/auth/login') }}">Entrar</a></p>
            </form>
          </div>
        </div>
      </div>
